...
export async function readChunk(filePath: fs.PathLike, {length, startPosition}: any) {
...
export function readChunkSync(filePath: fs.PathLike, { length, startPosition }: any) {
